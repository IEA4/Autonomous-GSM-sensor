...
#define critical_Chardge 3500     // напряжение, ниже которого отключается внешнее прерывание, модуль усыпляется на несколько дней, пока напряжение не станет ниже допустимого
...
bool flag_det;                          // флажок чтоб удостовериться что было пробуждение по прерыванию
